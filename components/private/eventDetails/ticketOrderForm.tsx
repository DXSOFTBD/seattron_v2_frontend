    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data.data.paid === true) {
          ...
          axios.get(`/ticket-order/free/${res.data.data._id}`)
            .then((res) => {
              push(`${process.env.NEXT_PUBLIC_CLIENT_HOST}/events/ticket-order/success`)
            })
            .catch((err) => {
                  ...
                  <Form className='mt-8 text-center'>
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                      <div className='flex flex-col flex-nowrap justify-start items-start space-y-6 mb-6 md:mb-0'>
                        ...
                        <div className='h-full w-full p-4 text-start rounded-md bg-gray-600 text-white'>
                          <div className='font-semibold flex'>
                            <p className='text-lg font-semibold w-28'>Price:</p>
                      ...
                      <div className='flex flex-col space-y-6 text-white '>
                        <div className='flex items-center justify-start'>
                          <p className='w-150 text-start'>Name</p>
                          <div className='relative'>
                            <Field
                              name='name'
                              type='text'
                        ...
                        <div className='flex items-center justify-start'>
                          <p className='w-150 text-start'> Email</p>
                          <div className='relative'>
                            <Field
                              name='email'
                              type='email'
                        ...
                        {userId_type && (
                          <div className='flex items-center justify-start'>
                            <p className='w-150 text-start'>{userId_type}</p>
                            <div className='relative'>
                              <Field
                                name='id_number'
                                className='bg-gray-50 text-gray-800 text-red border-2 focus:outline-blue-300 focus:outline-1 text-sm py-1 h-d8 w-full md:w-300  px-2 rounded-md outline-none'
                        ...
                        {userPhone && (
                          <div className='flex items-center justify-start'>
                            <p className='w-150 text-start'> Phone number</p>
                            <div className='relative'>
                              <Field
                                name='phone'
                                type='phone'
                        ...
                        {userGender && (
                          <div className='flex items-center justify-start'>
                            <p className='w-150 text-start'> Gender</p>
                            <div className='relative'>
                              <Field
                                name='gender'
                                type='gender'
                        ...
                        {userAge && (
                          <div className='flex items-center justify-start'>
                            <p className='w-150 text-start'> Age</p>
                            <div className='relative'>
                              <Field
                                name='age'
                                type='number'
                        ...
                        {userOccupation && (
                          <div className='flex items-center justify-start'>
                            <p className='w-150 text-start'> Occupation</p>
                            <div className='relative'>
                              <Field
                                name='occupation'
                                type='occupation'
                        ...
                        {userCity && (
                          <div className='flex items-center justify-start'>
                            <p className='w-150 text-start'> City</p>
                            <div className='relative'>
                              <Field
                                name='city'
                                type='city'
                        ...
                        {userCountry && (
                          <div className='flex items-center justify-start'>
                            <p className='w-150 text-start'> Country</p>
                            <div className='relative'>
                              <Field
                                name='country'
                                type='country'
                        ...
                        {userPostal_code && (
                          <div className='flex items-center justify-start'>
                            <p className='w-150 text-start'> Postal Code</p>
                            <div className='relative'>
                              <Field
                                name='postal_code'
                                type='postal_code'
