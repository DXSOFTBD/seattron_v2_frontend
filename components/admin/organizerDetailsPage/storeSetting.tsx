...
const StoreSetting = ({ agent }: any) => {
  ...
  return (
    <div className='w-full text-start pb-32 lg:pb-0'>
      <div className='flex flex-wrap space-y-4 lg:space-y-0 lg:flex-nowrap space-x-4 max-w-[1280px]'>
        <div className='lg:w-[55%] w-full'>
          ...
          />
          <div className='absolute lg:relative bottom-0 left-4'>
