...
import DonutChart from '@/components/common/widgets/donut-chart';
...
const Report = () => {
  ...
  const status = useAppSelector(
    (state) => state.orderReducer.getAllAdminOrders.status
  );
  ...
  return (
    <>
      ...
      <div className='lg:grid flex  flex-wrap lg:grid-cols-4'>
        <div className=' lg:col-span-3 w-full'>
          <div className='w-full  grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-6'>
            ...
            <div className='w-full '>
              <StickerCard
                title='VAT Received'
                value={analytics.totalVatReceived}
              />
            </div>
          </div>
        </div>
        <div className='w-full'>
          <DonutChart
            series={[2323, 234]}
            colors={['#23saf3', '#00b2d6']}
            labels={['Seattron Fee', 'Total Revenue']}
          />
        </div>
      </div>
